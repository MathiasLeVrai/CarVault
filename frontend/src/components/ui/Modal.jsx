...
export default function Modal({ isOpen, onClose, title, children }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center md:p-4">
      ...
      <div className="relative w-full md:max-w-xl max-h-[92vh] md:max-h-[90vh] flex flex-col bento-card p-0 overflow-hidden animate-pop rounded-t-3xl md:rounded-3xl border border-white/10">
        <div className="flex items-center justify-between px-6 md:px-8 py-5 border-b border-white/5 bg-white/[0.02]">
