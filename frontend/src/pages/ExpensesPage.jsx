...
const catFilters = [{value:'',label:'Toutes'},{value:'MAINTENANCE',label:'Entretien'},{value:'OIL_CHANGE',label:'Vidange'},{value:'BRAKES',label:'Freins'},{value:'TIRES',label:'Pneus'},{value:'BODYWORK',label:'Carrosserie'},{value:'TECHNICAL_INSPECTION',label:'CT'},{value:'PARKING',label:'Parking'},{value:'TOLL',label:'Péage'},{value:'CLEANING',label:'Lavage'},{value:'FINE',label:'Amende'},{value:'OTHER',label:'Autre'}];
